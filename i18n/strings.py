...
TEXTS = {
    "ru": {
        ...
        "list_tz_intro_user": "Время — в <b>твоём</b> поясе из настроек: {zone}. В скобках — если событие создавали в другом поясе.",
        "list_event_tz_marker": "создано в {zone}",
        ...
        "list_history_tz_intro": "Время — в твоём поясе: {zone} (как в ⚙️ Настройки).",
        "list_completed_empty": "Пока нет выполненных событий. После напоминания нажми «✅ Выполнено» или отметь из списка.",
        "list_cancelled_empty": "Пока нет отменённых. В уведомлении о событии нажми «🚫 Отменить» — оно попадёт сюда.",
    ...
    "en": {
        ...
        "list_tz_intro_user": "Times are in <b>your</b> settings timezone: {zone}. Parentheses if the event was created in another zone.",
        "list_event_tz_marker": "created in {zone}",
        ...
        "list_history_tz_intro": "Times in your zone: {zone} (⚙️ Settings).",
        "list_completed_empty": "No completed events yet. After a reminder, tap ✅ Done.",
        "list_cancelled_empty": "No cancelled events yet. In a notification, tap 🚫 Cancel to add one here.",
